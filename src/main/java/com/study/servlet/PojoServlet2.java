...
public class PojoServlet2 extends HttpServlet {
    // get 요청시 Profile 객체들이 3개 담긴 리스트를
    // 응답하는 코드를 작성해주세요
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Profile> profileList = List.of(
                new Profile("홍길동", 20, "hong@sample.com"),
                new Profile("홍길서", 25, "gilseo@sample.com"),
                new Profile("홍길남", 30, "gilnam@sample.com")
        );
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        com.study.entity.Profile profile = objectMapper.readValue(reader, Profile.class); // java객체로 변환
